...
const VERSION = 'offair-v10';
const SHELL = ['./', './index.html', './style.css', './app.js', './quiz.js', './saver.js', './stream.js', './lyrics.js', './stations.js', './manifest.webmanifest', './icons/icon-192.png', './icons/icon-512.png'];
